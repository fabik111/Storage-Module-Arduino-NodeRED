...
var APIDir='https://api-dev.arduino.cc/iot/v1';
...
module.exports = {
    ...
    genericRequest: function(url, method, body) {
        return fs.readFile(homeDir + '/.nodered/oauth.json', 'utf8').then(function(data){
